...
myGui.SetFont("s6 cWhite")
LogBtn := myGui.Add("Button", "w175", "LOG")
myGui.Add("Text", "ys w125 cWhite vLastAcc", "Last Logged Acc: 00000000")
PageBtn := myGui.Add("Button", "ys w150", "PAGE")
...
myGui.Add("Text", "ys w175 cYellow vCounterText", "Total Count: 0  | CT: 0  | US: 0  | MRI: 0")
myGui.Add("Text", "ys w125 cAqua vWeightedCountText", "Weighted Count: 0")
ShowLogBtn := myGui.Add("Button", "ys w150", "Show List").OnEvent("Click", ShowLog)
...
WinSetTransparent(200)
listGui.SetFont("s8 cRed")
listBox := listGui.Add("ListBox", "r8 vscroll vListSelect")
listGui.Add("Button", "w120", "Log Current").OnEvent("Click", LogButton)
listGui.Add("Button", "w120", "Delete").OnEvent("Click", RemoveSelectedEntry)
